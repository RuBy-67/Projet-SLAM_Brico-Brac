            ...
            <div class="flex sm:flex-row flex-col items-center">
                ...
                if (isset($user)) {
                    ...
                    if ($usergroup  === 1 || $usergroup === 2) {
                        ...
                        echo '<a href="/Projet-SLAM_Brico-Brac/admin/admin.php" class="btn mr-4 mb-4">Gestion</a>';
                    }
                    echo '</div>';
                } else {
                    // Utilisateur non connecté
                    echo '<div class="flex sm:flex-row flex-col items-center">';
                    echo '<a href="/Projet-SLAM_Brico-Brac/pages/sign_in.php" class="btn mr-4 mb-4">Se connecter</a>';
                    echo '<a href="/Projet-SLAM_Brico-Brac/pages/sign_up.php" class="btn mr-4 mb-4">Créer un compte</a>';
                    echo '</div>';
                }
                ?>
            </div>
